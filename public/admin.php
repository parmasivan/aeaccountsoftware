...
$user = requirePageAuth(['admin']);
?><!DOCTYPE html>
<html lang="ta">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>AE Accounts Admin Page</title>
    ...
    <div class="page">
        <header class="hero">
            <div>
                ...
                <p class="lead">இந்த page-ல் admin மட்டும் product add, price maintain, stock monitor, sales/expense ledger எல்லாம் manage பண்ணலாம்.</p>
            </div>
            <div class="hero-card">
        ...
        <section class="grid grid-3">
            ...
            <div class="panel">
                <div class="panel-head">
                    <h2>Expense Entry</h2>
                    <span class="muted">Rent / EB / Salary</span>
                </div>
        ...
        <section class="grid grid-2">
            <div class="panel">
                <div class="panel-head">
                    <h2>Admin Product & Price Master</h2>
                    <span class="muted">Only admin can add product and price</span>
                </div>
            ...
            <div class="panel">
                <div class="panel-head">
                    <h2>Low Stock + Expenses</h2>
                    <span class="muted">Admin follow-up</span>
                </div>
        ...
        <section class="panel top-gap-lg">
            <div class="panel-head">
                <h2>Ledger</h2>
                <span class="muted">Income / Expense / Purchase</span>
            </div>
